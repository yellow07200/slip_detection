/*
 * CompressiveForceGrasp.h
 *
 *  Created on: Aug 8, 2019
 *      Author: user
 */

#ifndef SLIP_DETECTION_DAVIS_SRC_COMPRESSIVEFORCEGRASP_H_
#define SLIP_DETECTION_DAVIS_SRC_COMPRESSIVEFORCEGRASP_H_
...
#include <slip_detection_davis/CompressiveForceGrasp_stable_Final.h>
// Gripper
...
//	  timespec aa, bb;
  	...
  	double elaspedTimeGrip=0;
  		  	...
  		  	slip_detection_davis::CompressiveForceGrasp_stable_Final Data;
...
//  		  double HARRIS_MIN, HARRIS_MAX;
  ...
  ros::Publisher flat_events_pub, edge_events_pub, corner_events_pub, event_frames_pub, test_pub; // Publish classified online events
...
//  	  dvs_msgs::EventArray packets_edge;
  ...
  //  std::string condition, object, detector;
    ...
    //defined parameters
  	std::string gripper_material ="50_hardness";
  	std::string object_size ="large_nut";
  	int Grip_Holding_value =100;
  	int frame_ms =1;
...
#endif /* SLIP_DETECTION_DAVIS_SRC_COMPRESSIVEFORCEGRASP_H_ */
