/*
 * SlipDetectionRawTest.h
 *
 *  Created on: Oct 9, 2019
 *      Author: user
 */

#ifndef SLIP_DETECTION_DAVIS_SRC_SLIPDETECTIONRAWTEST_H_
#define SLIP_DETECTION_DAVIS_SRC_SLIPDETECTIONRAWTEST_H_
...
{
class SlipDetectionRawTest
		{
public:
//	  baxter_gripper_server::ElectricParallelGripper left_grippers;

	  SlipDetectionRawTest();
	virtual ~SlipDetectionRawTest();
...
//  		  double HARRIS_MIN, HARRIS_MAX;
  ...
  std_msgs::Header head_data;
    ...
    geometry_msgs::WrenchStamped FT_readings, f_max_data,t_max_data, FT_readings_interval;
    baxter_core_msgs::EndEffectorState gripper_percentage;
    bool gripper_stopped,  gripper_check;

    bool control_start, slip_seperate_monitor;

    int  only_slip_flat, only_slip_edge, only_slip_corner, only_slip_raw;


	double threshold_edge, threshold_flat, threshold_raw;
...
#endif /* SLIP_DETECTION_DAVIS_SRC_SLIPDETECTIONRAWTEST_H_ */
