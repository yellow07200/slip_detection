...
static void publish_frame_millisec_desired(slip_detection_davis::soft_hand_slip_detection* data_ccollector)
{
	while (ros::ok())
		{
...
static void run_controller_desired(slip_detection_davis::soft_hand_slip_detection* data_ccollector)
{
...
//		data_ccollector->slip_control_optic();

			}
}

//static void publish_complete_msg_full(slip_detection_davis::soft_hand_slip_detection* data_ccollector)
//{
//	while (ros::ok())
//		{
...
//static void slip_monitor_millisec(slip_detection_davis::soft_hand_slip_detection* data_ccollector)
//{
////	while (ros::ok())
////			{
...
//static void FT_spin_desired(slip_detection_davis::soft_hand_slip_detection* ft)
//{
//	while (ros::ok())
//		{
////    std::this_thread::sleep_for(std::chrono::milliseconds(10));
...
//			  std::cout <<"cmd_grip_force----" <<cmd_grip_force<< std::endl;
	  ...
	  slip_detection_davis::soft_hand_slip_detection* processs;
...
std::thread th5(&slip_control_millisec, processs); // only when controller used
